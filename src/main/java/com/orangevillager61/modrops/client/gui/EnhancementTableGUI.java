package com.orangevillager61.modrops.client.gui;
...
public class EnhancementTableGUI extends ContainerScreen<EnhancementContainer>{

	   private TextFieldWidget nameField;

	   public EnhancementTableGUI(EnhancementContainer p_i51103_1_, PlayerInventory p_i51103_2_, ITextComponent p_i51103_3_) {
	   ...
	   void func_214075_a(String p_214075_1_) {
	   ...
	   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
	      ...
	      this.minecraft.getTextureManager().bindTexture(new ResourceLocation(MoDrops.modid, "textures/gui/container/enhancement_table.png"));
	      int i = (this.width - this.xSize) / 2;
	      int j = (this.height - this.ySize) / 2;
