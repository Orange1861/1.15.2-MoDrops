...
public class StoneBrineFilter extends Block {

	protected static final EnumProperty<EnumType> TYPE = EnumProperty.create("type", StoneBrineFilter.EnumType.class);
	protected static final VoxelShape Shape = VoxelShapes.create(0.0F, 0.0F, 0.0F, 1.0F, 0.75F, 1.0F);
	
	public StoneBrineFilter(Properties properties) {
		super(properties);
	...
	public enum EnumType implements IStringSerializable {
		EMPTY(0, "empty"), FULL1(1, "1full"), FULL(2, "full");
