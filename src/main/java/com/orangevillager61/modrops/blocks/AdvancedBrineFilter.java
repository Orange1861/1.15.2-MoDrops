...
public class AdvancedBrineFilter extends Block {

	protected static final EnumProperty<EnumType> TYPE = EnumProperty.create("type", AdvancedBrineFilter.EnumType.class);
	protected static final VoxelShape Shape = VoxelShapes.create(0.0F, 0.0F, 0.0F, 1.0F, 0.75F, 1.0F);
	
	public AdvancedBrineFilter(Properties properties) {
		super(properties);
